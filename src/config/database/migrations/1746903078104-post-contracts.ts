...
export class PostContracts1746903078104 implements MigrationInterface {
    name = 'PostContracts1746903078104'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "sportEaze"."Posts" ADD "contractId" uuid`);
        await queryRunner.query(`ALTER TABLE "sportEaze"."Posts" ADD CONSTRAINT "UQ_e97295d43146eedfbced74f9af8" UNIQUE ("contractId")`);
        await queryRunner.query(`ALTER TABLE "sportEaze"."Posts" ADD "milestoneId" uuid`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sportEaze"."Posts" DROP COLUMN "milestoneId"`);
        await queryRunner.query(`ALTER TABLE "sportEaze"."Posts" DROP CONSTRAINT "UQ_e97295d43146eedfbced74f9af8"`);
        await queryRunner.query(`ALTER TABLE "sportEaze"."Posts" DROP COLUMN "contractId"`);
    }
